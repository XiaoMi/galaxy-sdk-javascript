...
Thrift.TXHRTransport.prototype = {
    ...
    jqRequest: function(client, postData, args, recv_method) {
        ...
        var jqXHR = jQuery.ajax({
            ...
            converters: {
                'text thrift' : function(responseData) {
                    ...
                    return recv_method.call(client);
                }
            },
            context: client,
        ...
        var jqError = jqXHR.error;
        jqXHR.error = function(error){
            jqError(function(jqXHR, textStatus, errorThrown) {
                if (jqXHR.readyState === 4) {
                    thriftTransport.setRecvBuffer(jqXHR.responseText);
                    try {
                        recv_method.call(client);
                    } catch (e) {
                        if (!(e instanceof SyntaxError)) {
                            // throw Galaxy Exception
