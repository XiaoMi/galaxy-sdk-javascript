...
Snapshot.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.I32) {
        this.snapshotState = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
SnapshotTableView = function(args) {
  this.tableName = null;
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.BOOL) {
        this.tableExist = input.readBool().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 3:
      if (ftype == Thrift.Type.I64) {
        this.deleteTime = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
...
QuotaInfo.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.I32) {
        this.tableNum = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 3:
      if (ftype == Thrift.Type.I32) {
        this.tableNumUsed = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 4:
      if (ftype == Thrift.Type.I64) {
        this.space = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 5:
      if (ftype == Thrift.Type.I64) {
        this.spaceUsed = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 7:
      if (ftype == Thrift.Type.I64) {
        this.readCapacityUsed = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 9:
      if (ftype == Thrift.Type.I64) {
        this.writeCapacityUsed = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
