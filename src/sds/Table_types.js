    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i108 = 0; _i108 < _size103; ++_i108)
        {
          ...
          val110 = new LocalSecondaryIndexSpec();
          val110.read(input);
...
InternalMutationLogEntry = function(args) {
  this.record = null;
  this.type = null;
...
InternalMutationLogEntry.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 3:
      if (ftype == Thrift.Type.BOOL) {
        this.rowDeleted = input.readBool().value;
      } else {
        input.skip(ftype);
      }
      break;
...
MutationLogEntry = function(args) {
  this.record = null;
  this.type = null;
  this.rowDeleted = null;
  this.timestamp = null;
