...
StreamSpec.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRING) {
        this.streamId = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 2:
      if (ftype == Thrift.Type.BOOL) {
        this.enableStream = input.readBool().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 3:
      if (ftype == Thrift.Type.I32) {
        this.viewType = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
StreamSpec.prototype.write = function(output) {
  ...
  if (this.enableStream !== null && this.enableStream !== undefined) {
    output.writeFieldBegin('enableStream', Thrift.Type.BOOL, 2);
    output.writeBool(this.enableStream);
    output.writeFieldEnd();
  }
  if (this.viewType !== null && this.viewType !== undefined) {
    output.writeFieldBegin('viewType', Thrift.Type.I32, 3);
...
TableMetadata.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 9:
      if (ftype == Thrift.Type.STRUCT) {
        this.exceededThroughput = new ProvisionThroughput();
      ...
      case 10:
      if (ftype == Thrift.Type.STRUCT) {
        this.slaveThroughput = new ProvisionThroughput();
      ...
      case 11:
      if (ftype == Thrift.Type.STRUCT) {
        this.exceededSlaveThroughput = new ProvisionThroughput();
...
ScanRequest.prototype.write = function(output) {
  ...
  if (this.startKey !== null && this.startKey !== undefined) {
    ...
    output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRUCT, Thrift.objectLength(this.startKey));
    for (var kiter283 in this.startKey)
    {
      if (this.startKey.hasOwnProperty(kiter283))
      {
        var viter284 = this.startKey[kiter283];
  ...
  if (this.stopKey !== null && this.stopKey !== undefined) {
    ...
    output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRUCT, Thrift.objectLength(this.stopKey));
    for (var kiter285 in this.stopKey)
    {
      if (this.stopKey.hasOwnProperty(kiter285))
      {
        var viter286 = this.stopKey[kiter285];
  ...
  if (this.attributes !== null && this.attributes !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRING, this.attributes.length);
    for (var iter287 in this.attributes)
    {
      if (this.attributes.hasOwnProperty(iter287))
      {
        iter287 = this.attributes[iter287];
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i293 = 0; _i293 < _size288; ++_i293)
        {
          ...
          val295 = new Datum();
          val295.read(input);
          this.nextStartKey[key294] = val295;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i301 = 0; _i301 < _size296; ++_i301)
        {
          ...
          var _ktype304 = 0;
          var _vtype305 = 0;
          _rtmp3307 = input.readMapBegin();
          _ktype304 = _rtmp3307.ktype;
          _vtype305 = _rtmp3307.vtype;
          ...
          for (var _i308 = 0; _i308 < _size303; ++_i308)
          {
            ...
            var key309 = null;
            var val310 = null;
            key309 = input.readString().value;
            val310 = new Datum();
            val310.read(input);
            elem302[key309] = val310;
          }
          input.readMapEnd();
          this.records.push(elem302);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ScanResult.prototype.write = function(output) {
  ...
  if (this.nextStartKey !== null && this.nextStartKey !== undefined) {
    ...
    for (var kiter311 in this.nextStartKey)
    {
      if (this.nextStartKey.hasOwnProperty(kiter311))
      {
        var viter312 = this.nextStartKey[kiter311];
        output.writeString(kiter311);
        viter312.write(output);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
  ...
  if (this.records !== null && this.records !== undefined) {
    ...
    for (var iter313 in this.records)
    {
      if (this.records.hasOwnProperty(iter313))
      {
        iter313 = this.records[iter313];
        output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRUCT, Thrift.objectLength(iter313));
        for (var kiter314 in iter313)
        {
          if (iter313.hasOwnProperty(kiter314))
          {
            var viter315 = iter313[kiter314];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem322 = null;
          elem322 = new BatchRequestItem();
          elem322.read(input);
          this.items.push(elem322);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
BatchRequest.prototype.write = function(output) {
  ...
  if (this.items !== null && this.items !== undefined) {
    ...
    for (var iter323 in this.items)
    {
      if (this.items.hasOwnProperty(iter323))
      {
        iter323 = this.items[iter323];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem330 = null;
          elem330 = new BatchResultItem();
          elem330.read(input);
          this.items.push(elem330);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
BatchResult.prototype.write = function(output) {
  ...
  if (this.items !== null && this.items !== undefined) {
    output.writeFieldBegin('items', Thrift.Type.LIST, 1);
    output.writeListBegin(Thrift.Type.STRUCT, this.items.length);
    for (var iter331 in this.items)
    {
      if (this.items.hasOwnProperty(iter331))
      {
        iter331 = this.items[iter331];
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i345 = 0; _i345 < _size340; ++_i345)
        {
          ...
          val347 = new EditDatum();
          val347.read(input);
          this.edits[key346] = val347;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
RowEdit.prototype.write = function(output) {
  ...
  if (this.keys !== null && this.keys !== undefined) {
    ...
    output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRUCT, Thrift.objectLength(this.keys));
    for (var kiter348 in this.keys)
    {
      if (this.keys.hasOwnProperty(kiter348))
      {
        var viter349 = this.keys[kiter348];
  ...
  if (this.edits !== null && this.edits !== undefined) {
    ...
    for (var kiter350 in this.edits)
    {
      if (this.edits.hasOwnProperty(kiter350))
      {
        var viter351 = this.edits[kiter350];
...
GetNewImageRequest = function(args) {
  this.tableName = null;
  this.partitionId = null;
  this.limit = null;
  this.offset = 0;
...
GetNewImageRequest.prototype = {};
GetNewImageRequest.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
GetNewImageRequest.prototype.write = function(output) {
  output.writeStructBegin('GetNewImageRequest');
  if (this.tableName !== null && this.tableName !== undefined) {
    output.writeFieldBegin('tableName', Thrift.Type.STRING, 1);
    output.writeString(this.tableName);
    output.writeFieldEnd();
...
GetNewImageResult = function(args) {
  this.nextStartOffset = null;
  this.records = null;
  this.throttled = null;
  if (args) {
    if (args.nextStartOffset !== undefined) {
      this.nextStartOffset = args.nextStartOffset;
    }
    if (args.records !== undefined) {
      this.records = args.records;
    }
...
GetNewImageResult.prototype = {};
GetNewImageResult.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.I64) {
        this.nextStartOffset = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i357 = 0; _i357 < _size352; ++_i357)
        {
          ...
          var _ktype360 = 0;
          var _vtype361 = 0;
          _rtmp3363 = input.readMapBegin();
          _ktype360 = _rtmp3363.ktype;
          _vtype361 = _rtmp3363.vtype;
          ...
          for (var _i364 = 0; _i364 < _size359; ++_i364)
          {
            ...
            var key365 = null;
            var val366 = null;
            key365 = input.readString().value;
            val366 = new Datum();
            val366.read(input);
            elem358[key365] = val366;
          }
          input.readMapEnd();
          this.records.push(elem358);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
GetNewImageResult.prototype.write = function(output) {
  output.writeStructBegin('GetNewImageResult');
  if (this.nextStartOffset !== null && this.nextStartOffset !== undefined) {
    output.writeFieldBegin('nextStartOffset', Thrift.Type.I64, 1);
    output.writeI64(this.nextStartOffset);
    output.writeFieldEnd();
  }
  if (this.records !== null && this.records !== undefined) {
    output.writeFieldBegin('records', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.MAP, this.records.length);
    for (var iter367 in this.records)
    {
      if (this.records.hasOwnProperty(iter367))
      {
        iter367 = this.records[iter367];
        output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRUCT, Thrift.objectLength(iter367));
        for (var kiter368 in iter367)
        {
          if (iter367.hasOwnProperty(kiter368))
          {
            var viter369 = iter367[kiter368];
